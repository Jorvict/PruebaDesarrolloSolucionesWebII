...
<br/><label for="ApellidoPaterno">{{'Apellido Paterno'}}</label>
<input type="text" name="ApellidoPaterno" id="ApellidoPaterno" value="{{$empleado->ApellidoPaterno}}">
<br/><label for="ApellidoMaterno">{{'Apellido Materno'}}</label>
...
<br/><label for="Foto"><img src="{{ asset('storage').'/'.$empleado->Foto}} " alt="" width="200" ></label>
<!-- <br/>{{$empleado->Foto}} -->
<br/><input type="file" name="Foto" id="Foto" value="">
